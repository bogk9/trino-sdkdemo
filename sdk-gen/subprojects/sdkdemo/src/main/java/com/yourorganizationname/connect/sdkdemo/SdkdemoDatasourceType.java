...
public class SdkdemoDatasourceType extends CustomFlightDatasourceType
{
    /**
     * An instance of the custom Apache Derby data source type.
     */
    public static final SdkdemoDatasourceType INSTANCE = new SdkdemoDatasourceType();

    /**
     * The unique identifier name of the data source type.
     */
    public static final String DATASOURCE_TYPE_NAME = "sdkdemo";
    private static final String DATASOURCE_TYPE_LABEL = "sdkdemo";
    private static final String DATASOURCE_TYPE_DESCRIPTION = "sdkdemo (SDK)";

    public SdkdemoDatasourceType()
    {
        super();
